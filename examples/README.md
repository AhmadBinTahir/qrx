...
1. **All QR types** (`type-*.svg`):
   `type-url.svg`, `type-app.svg`, `type-text.svg`, `type-map.svg`, `type-wifi.svg`, `type-media.svg`, `type-document.svg`, `type-message.svg`, `type-social.svg`, `type-video.svg`, `type-google.svg`, `type-payment.svg`, `type-coupon.svg`, `type-vcard.svg`, `type-calendar.svg`, `type-multi-url.svg`, `type-link-list.svg`, `type-booking.svg`, `type-custom.svg`
